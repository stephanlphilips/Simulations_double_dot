...
def add_nuclear_and_charge_noise(sim_object, T2_electric=0.6e-6):
	...
	B_noise_1.init_gauss(sim_object.H_B_field1,1.5e-6)

	# T2* qubit 2 -- nuclear
	B_noise_2 = me.noise_py()
	B_noise_2.init_gauss(sim_object.H_B_field2,0.9e-6)
...
def test_t2():
	...
	db.calc_time_evolution(psi0, 0e-9, 1000e-9, 5000)
	db.plot_expect()
	db.plot_pop()
