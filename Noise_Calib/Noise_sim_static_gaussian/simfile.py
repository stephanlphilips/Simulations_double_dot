...
def expected_value(t, T2_electric,right_qubit = True, num_sim=100):
	...
	t /= 2
	db = noise.add_nuclear_and_charge_noise(db,T2_electric)
...
# a= expected_value(1.69e-6, 600e-9, right_qubit=False)
# print(a)
density = 80
