...
plot 'DJ1_dec.txt' u ($1-255):2:($6) w errorbars title "00" ls 1 ,\
	'DJ1_dec.txt' u ($1-255):4:($7) w errorbars title "01" ls 2,\
	'DJ1_dec.txt' u ($1-255):3:($8) w errorbars title "10" ls 3,\
	'DJ1_dec.txt' u ($1-255):5:($9) w errorbars title "11" ls 4,\
...
plot 'DJ2_dec.txt' u ($1-265):2:($6) w errorbars title "00" ls 1 ,\
	'DJ2_dec.txt' u ($1-265):4:($7) w errorbars title "01" ls 2,\
	'DJ2_dec.txt' u ($1-265):3:($8) w errorbars title "10" ls 3,\
	'DJ2_dec.txt' u ($1-265):5:($9) w errorbars title "11" ls 4,\
...
plot 'DJ3_dec.txt' u ($1-255):2:($6) w errorbars title "00" ls 1 ,\
	'DJ3_dec.txt' u ($1-255):4:($7) w errorbars title "01" ls 2,\
	'DJ3_dec.txt' u ($1-255):3:($8) w errorbars title "10" ls 3,\
	'DJ3_dec.txt' u ($1-255):5:($9) w errorbars title "11" ls 4,\
...
plot 'DJ4_dec.txt' u ($1-265):2:($6) w errorbars title "00" ls 1 ,\
	'DJ4_dec.txt' u ($1-265):4:($7) w errorbars title "01" ls 2,\
	'DJ4_dec.txt' u ($1-265):3:($8) w errorbars title "10" ls 3,\
	'DJ4_dec.txt' u ($1-265):5:($9) w errorbars title "11" ls 4,\
